...
Test('Should Create Generic 1', () => {
  const T: Type.TGeneric<[Type.TParameter<'A', Type.TUnknown, Type.TUnknown>], Type.TTuple<[Type.TRef<'A'>, Type.TNumber]>> 
    = Type.Generic([Type.Parameter('A')], Type.Tuple([Type.Ref('A'), Type.Number()]))
})

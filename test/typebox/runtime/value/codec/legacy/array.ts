...
const Test = Assert.Context('Value.Codec.Legacy.Array')
...
Test('Should Array 2', () => {
  ...
  const D = Decode(BoxedElements, [1, 2, 3, 4, 5])
  const E = Encode(BoxedElements, D)
  Assert.IsEqual(D, [['1'], ['2'], ['3'], ['4'], ['5']])
  Assert.IsEqual(E, [1, 2, 3, 4, 5])
})
// ------------------------------------------------------------------
...
Test('Should Array 3', () => {
  ...
  const D = Decode(DeepArray, [[1, 2, 3], [4, 5, 6]])
  const E = Encode(DeepArray, D)
...
Test('Should Array 4', () => {
  ...
  const D = Decode(DeepReversedArray, [[1, 2, 3], [4, 5, 6]])
  const E = Encode(DeepReversedArray, D)
...
Test('Should Array 6', () => {
  ...
  Assert.Throws(() => Decode(Array, {}))
  Assert.Throws(() => Encode(Array, {}))
})

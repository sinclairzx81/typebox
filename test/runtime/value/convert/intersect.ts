...
describe('value/convert/Intersect', () => {
  ...
  it('Should convert first value for object exclusive intersect 1', () => {
    // prettier-ignore
    const T = Type.Intersect([
      Type.Number(),
      Type.Object({ x: Type.Number() }),
  ...
  it('Should convert first value for object exclusive intersect 2', () => {
    // prettier-ignore
    const T = Type.Intersect([
      Type.Object({ x: Type.Number() }),
      Type.Object({ y: Type.Number() }),

(function () {
  ...
  define("test/index", ["require", "exports", "src/index"], function (require, exports, typebox) {
      "use strict";
      exports.__esModule = true;
      var Ship = typebox.Object({
          pilot: typebox.String(),
          position: typebox.Tuple(typebox.Number(), typebox.Number()),
          color: typebox.Union(typebox.Literal("red"), typebox.Literal("blue"), typebox.Literal("green"))
      });
      var result = typebox.schema(Ship);

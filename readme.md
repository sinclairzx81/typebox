...
TypeBox can be used as a simple tool to build up complex schemas or integrated into RPC and REST services to help validate JSON data received over the wire. It is designed to integrate seemlessly with the Ajv validation library; but also provides an optional high performance validator with comparable performance built in.

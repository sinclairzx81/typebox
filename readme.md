...
TypeBox can be used as a simple tool to build up complex schemas or integrated into RPC and REST services to help validate JSON data received over the wire. It is desgined to integrate seemlessly with the Ajv validation library; but also includes an optional high performance validator with comparable performance built in.

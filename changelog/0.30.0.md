...
Revision 0.30.0 is a milestone revision for the TypeBox project. This revision is primarily focused on internal refactorings to reduce bundle size, further support modularity of internal modules and consolidating shared utility modules. This revision also implements several new features, including new validation constraints for Array, new iterator types, new code generation options for the compiler, and internal changes to how modifiers work. This release also includes new examples for transform types as well as a reference implementation for JSON Type Definition.

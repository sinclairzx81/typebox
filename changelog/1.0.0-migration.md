...
The Const type has been removed in 1.0. This type was used to create structural type representations from constant TypeScript values. 1.0 deprecates this functionality in favor of Script which can parse values into structural representations.
...
// Optional: If readaonly is required.

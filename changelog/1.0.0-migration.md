...
TypeBox 1.0 removes the SetErrorFunction callback. This callback was original written to support internationalization (i18n) hooks for error messages. Version 1.0 introduces built-in support for error message localization, as such this callback has been removed. Error message localization has been moved to the `system` module.
...
Locale.Set(Locale.fr_FR)
Locale.Set(Locale.ko_KR)
Locale.Reset()
```

...
Version 1.0 introduces a new module for handling reference types. This change is reflected across Value and Compiler submodules. In 1.0, references are passed via a optional Context object. This replaces the `references` array in 0.34.x. 

...
- Breaking
  ...
  - [Intersect Schema Representation](#Breaking-Changes-Intersect)
  - [Value Cast and Convert](#Breaking-Changes-Value-Cast)
  - [Identifiers Removed for Inline Compositions](#Breaking-Changes-)
  - [Format Renamed to FormatRegistry](#breaking-Changes-Format)
  - [Custom Renamed to TypeRegistry](#breaking-Changes-Custom)
  - [TypeSystem Renamed Functions](#Breaking-Changes-Type-System)
...
<a name="TypeSystem-Renamed-Functions"></a>

## TypeSystem Renamed Functions
...
const F = TypeSystem.Type('MyFormat' value => true)
```